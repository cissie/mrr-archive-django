...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReviewerName.reviewer_name'
        db.alter_column(u'library_reviewername', 'reviewer_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ReviewerName.reviewer_name'
        raise RuntimeError("Cannot reverse this migration. 'ReviewerName.reviewer_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ReviewerName.reviewer_name'
        db.alter_column(u'library_reviewername', 'reviewer_name', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        u'library.recordtitle': {
            ...
            'cover_art': ('django.db.models.fields.files.ImageField', [], {'default': "'img/vinyl.tif'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
