...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssueNumber.issue_number'
        db.alter_column(u'library_issuenumber', 'issue_number', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'IssueNumber.issue_number'
        db.alter_column(u'library_issuenumber', 'issue_number', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'library.recordtitle': {
            ...
            'cover_art': ('django.db.models.fields.files.ImageField', [], {'default': "'img/cover_images/vinyl.tif'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
