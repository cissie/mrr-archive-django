...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RecordReview.user'
        db.delete_column(u'library_recordreview', 'user_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RecordReview.user'
        raise RuntimeError("Cannot reverse this migration. 'RecordReview.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'RecordReview.user'
        db.add_column(u'library_recordreview', 'user',
