...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecordTitle.in_collection'
        db.add_column(u'library_recordtitle', 'in_collection',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'RecordTitle.stolen'
        db.add_column(u'library_recordtitle', 'stolen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RecordTitle.wanted'
        db.add_column(u'library_recordtitle', 'wanted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ReleaseYear.release_year'
        db.alter_column(u'library_releaseyear', 'release_year', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):
        # Deleting field 'RecordTitle.in_collection'
        db.delete_column(u'library_recordtitle', 'in_collection')

        # Deleting field 'RecordTitle.stolen'
        db.delete_column(u'library_recordtitle', 'stolen')

        # Deleting field 'RecordTitle.wanted'
        db.delete_column(u'library_recordtitle', 'wanted')


        # Changing field 'ReleaseYear.release_year'
        db.alter_column(u'library_releaseyear', 'release_year', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'library.issuenumber': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue_number': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '3'})
        },
        u'library.notes': {
        ...
        u'library.recordtitle': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_collection': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'stolen': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'wanted': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'library.releaseyear': {
            'Meta': {'object_name': 'ReleaseYear'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'release_year': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '4'})
        },
        u'library.reviewername': {
            'Meta': {'object_name': 'ReviewerName'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reviewer_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
